...
$string['showloginform'] = 'Mostrar formulario de acceso por defecto';
$string['showloginform_desc'] = 'Si su sitio usa métodos de autenticación que no requieren que los usuarios introduzcan su correo/nombre de usuario y contraseña, como OAuth2, puede que usted quiera ocultar el formulario de acceso estándar. Esto no es compatible con cuentas manuales.

Si usted no puede acceder y usted quiere mostrar el formulario de acceso puede cambiar esta configuración con la línea de comando: php admin/cli/cfg.php --name=showloginform --set=1';
